#!/usr/bin/env python3
"""
List all IDs that are present in a composed tileset

Stored at
https://github.com/CleverRaven/Cataclysm-DDA/blob/master/tools/gfx_tools/
https://github.com/I-am-Erk/CDDA-Tilesets/blob/master/tools/
